"""
Django settings for Universal AI Web Scraper project.
"""
import os
...
DATABASES = {
    'default': dj_database_url.config(
        default=os.getenv(
            'DATABASE_URL',
            'postgresql://scraper_user:scraper_pass@localhost:5432/scraper_db'
        ),
        conn_max_age=600,
...
SCRAPER_CONFIG = {
    ...
    'DEFAULT_RATE_LIMIT': int(os.getenv('SCRAPER_DEFAULT_RATE_LIMIT', '1')),  # requests per second
